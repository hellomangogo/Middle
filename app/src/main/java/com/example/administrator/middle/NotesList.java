package com.example.administrator.middle;
...
public class NotesList extends ListActivity {
    ...
    private static final String[] QUERYBYTYTLE=new String[]{NotePad.Notes.COLUMN_NAME_TITLE};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView= (SearchView) findViewById(R.id.myquary);
        ...
        Cursor cursor = managedQuery(
                ...
                PROJECTION,                       // Return the note ID and title and timestamp for each note.
...
//        SimpleDateFormat sdf = new SimpleDateFormat("HH;mm:ss");
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfo) {
        ...
        // Inflate menu from XML resource
        MenuInflater inflater = getMenuInflater();
        inflater.inflate(R.menu.list_content_menu, menu);
